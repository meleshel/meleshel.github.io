...
scores[4] = 50;
//n.o 2
export function findAverage(scoresArray) {
    let total = 0;
...
console.log(arrayValue);
// → [5, 4, 3, 2, 1]*/
export function reverseArrayInPlace(numbers) {
...
export function generateArray(input1, input2) {
    let newArray = [];
    let counter = 1;
...
function sortThis(input1, input2, input3) {
    const result = [];
    if (input1 < input2 && input1 < input3) {
        result[0] = input1;
        if (input2 < input3) {
