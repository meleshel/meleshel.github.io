...
import { Person, includesEvenAge,doubleNums, doubleAges, filterEven, filterOver10, findEvenAge, findEvenNum } from "../src/arrayPractice.js";
...
describe("filter practice", function () {
    ...
    it("includes even age", function () {
        const result = includesEvenAge(peopleArray);
        console.log(result); 
